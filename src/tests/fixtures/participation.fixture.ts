...
import { I_PARTICIPATION_REPOSITORY } from '../../webinar/ports/participation-repository.interface';
import { IParticipationRepository } from '../../webinar/ports/participation-repository.interface';
